        ...
        <div className="flex flex-col items-center gap-4 mt-8">
            <div className="flex rounded-md overflow-clip ">
                {["Student", "Parent", "Educators"].map((tab) => (
                    <button
                        key={tab}
                        className={`py-2 min-w-28 font-semibold border ${activeTab === tab ? "bg-primary text-primary-foreground" : "bg-primary-foreground text-primary"}`}
                        onClick={() => {
                            setActiveTab(tab);
            ...
            <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg">
                ...
                <form onSubmit={handleLogin} className="flex flex-col gap-6">
                    {activeTab === "Student" ? (
                        <>
                            <label className="flex flex-col gap-2 text-primary text-sm">Name
                            ...
                            <label className="flex flex-col gap-2 text-primary text-sm">Code
                                <div className="relative">
                        ...
                        <>
                            <label className="flex flex-col gap-2 text-primary text-sm">Email
                                <div className="relative">
                            ...
                            <label className="flex flex-col gap-2 text-primary text-sm">Password
                                <div className="relative">
                                    <Lock size={12} className="absolute left-0 top-0 m-3.5 pointer-events-none" />
                                    <Input
                                        type="password"
