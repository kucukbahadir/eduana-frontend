...
const AdminDashboard = () => {
    return (<div className="p-6">
        ...
        <div className="grid grid-cols-1 gap-6 p-3">
            <Card>
                <div className="">
                    <h2 className="font-bold mb-4">Recent User Reports</h2>
                    <Table
                        headers={["User", "Report", "Time"]}
                        data={[["Bonnie Green", "Page UI Issue", "A few seconds ago"], ["Bonnie Green", "Page Loading Time", "A few seconds ago"],]}
                    />
                </div>
            </Card>
            <Card>
                <div className="">
                    <h2 className="font-bold mb-4">Manage Users</h2>
                    <Table
                        headers={["Name", "Username", "Role", "Action"]}
                        data={[["Jese Leos", "@jeseleos", "Teacher", "Manage"], ["Sieberen de Kuiper", "@subjectsigma", "Teacher", "Manage"], ["Jan Erik", "@janerik", "Intern Teacher", "Manage"], ["Sieglinde Weder", "@sieglindeweder", "Coordinator", "Manage"],]}
                    />
                </div>
            </Card>
        </div>
